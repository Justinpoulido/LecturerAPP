    ...
    private fun createGroup() {
        ...
        wifiP2pManager.createGroup(channel, object : WifiP2pManager.ActionListener {
            override fun onSuccess() {
                ...
                intent.putExtra("wifi_password", wifiPassword.text.toString().trim()) // Pass Wi-Fi password
                intent.putExtra("session_number", sessionNumber.text.toString()) // Pass session number
                intent.putExtra("session_type", sessionTypeSpinner.selectedItem?.toString() ?: "") // Pass session type
            ...
            override fun onFailure(reason: Int) {
                ...
                Toast.makeText(
                    this@StartClassActivity,
                    "Group creation failed: $errorMessage",
                    Toast.LENGTH_SHORT
                ).show()
                isGroupCreationInProgress = false // Reset flag
            }
